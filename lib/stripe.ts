...
export const PLANS: Record<string, PlanConfig> = {
  ...
  pro: {
    ...
    name: "Pro",
    price: 199,
    priceId: process.env.STRIPE_PRO_PRICE_ID || process.env.STRIPE_INTELLIGENCE_PRICE_ID || null,
    features: [
  ...
  enterprise: {
    ...
    name: "Enterprise",
    price: 499,
    priceId: process.env.STRIPE_ENTERPRISE_PRICE_ID || process.env.STRIPE_CARE_PRICE_ID || null,
    features: [
  ...
  // ── Legacy plans (backward compat for existing subscribers) ──
  intelligence: {
    id: "intelligence",
    name: "Intelligence",
    price: 99,
