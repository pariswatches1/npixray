  ...
  return (
    <div className="rounded-xl border border-[var(--border-light)] bg-white p-4">
      <div className="flex items-center gap-2 mb-3">
        <Code className="h-4 w-4 text-[#2F5EA8]" />
      ...
      <div className="relative">
        <pre className="text-xs font-mono bg-white rounded-lg p-3 pr-10 overflow-x-auto text-[var(--text-secondary)]">
          {embedCode}
        </pre>
        <button
          onClick={handleCopy}
          className="absolute top-2 right-2 p-1.5 rounded-md bg-white hover:bg-[#2F5EA8]/10 transition-colors"
