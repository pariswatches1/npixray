...
export function GroupCodingTab({ data }: Props) {
  ...
  const codingRows = [
    ...
    { code: "99214", label: "Level 4", pct: pct214, bench: avgBench214, color: "#E8A824" },
    ...
    <div className="space-y-8">
          ...
          {codingRows.map((row) => {
            ...
            return (
              <div key={row.code} className="space-y-2">
                ...
                <div className="relative h-6 bg-dark-900/50 rounded-full overflow-hidden">
                  {/* Benchmark line */}
                  <div
      ...
      <div className="rounded-2xl bg-dark-800/50 border border-dark-50/20 p-6">
          ...
          {providerEm.map((p) => (
            <div key={p.npi} className="flex items-center gap-3">
              ...
              <div className="flex-1 flex h-5 rounded-full overflow-hidden bg-dark-900/30">
                ...
                <div
                  className="h-full"
                  style={{ width: `${p.pct214}%`, backgroundColor: "#E8A824", opacity: 0.6 }}
              ...
              <span className="w-16 text-right text-xs font-mono text-gold shrink-0">
        ...
        <div className="flex items-center justify-center gap-6 mt-4 pt-4 border-t border-dark-50/10 text-xs text-dark-300">
          ...
          <span className="flex items-center gap-1.5">
            <span className="h-2.5 w-2.5 rounded-sm" style={{ backgroundColor: "#E8A824" }} />
            99214
          </span>
          <span className="flex items-center gap-1.5">
