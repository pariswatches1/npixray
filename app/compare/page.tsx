        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-12 sm:pt-28 sm:pb-16">
          ...
          <div className="text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-[#2F5EA8]/10 bg-[#2F5EA8]/[0.04] px-4 py-1.5 mb-8">
              <ArrowLeftRight className="h-3.5 w-3.5 text-[#2F5EA8]" />
            ...
            <h1 className="text-4xl sm:text-5xl font-bold tracking-tight max-w-3xl mx-auto leading-[1.1]">
              ...
              <span className="text-[#2F5EA8]">Side by Side Medicare Data</span>
            </h1>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-4">
                    <span className="text-sm font-semibold group-hover:text-[#2F5EA8] transition-colors truncate">
                      {a}
                    </span>
                  ...
                  <div className="mt-3 flex items-center justify-center gap-1 text-xs text-[var(--text-secondary)] group-hover:text-[#2F5EA8] transition-colors">
