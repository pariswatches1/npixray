        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl font-bold">
              Top Providers <span className="text-gold">by State</span>
            </h2>
          </div>
            ...
            {states.map((s) => {
              ...
              return (
                <Link
                  ...
                  className="group rounded-lg border border-dark-50/80 bg-dark-400/50 p-3 hover:border-gold/30 hover:shadow-md hover:shadow-gold/5 transition-all"
                >
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-xs font-mono text-[var(--text-secondary)]">
                      {s.state}
                    </span>
                    <ArrowRight className="h-3 w-3 text-[var(--text-secondary)] group-hover:text-gold transition-colors" />
                  </div>
                  <p className="text-sm font-semibold group-hover:text-gold transition-colors truncate">
                    {name}
                  </p>
      ...
      <section className="border-t border-dark-50/50 py-12 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl font-bold mb-6">
            More <span className="text-gold">Rankings</span>
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl">
            <Link
              href="/rankings/top-specialties"
              className="group flex items-center gap-4 rounded-xl border border-dark-50/80 bg-dark-400/50 p-5 hover:border-gold/30 transition-all"
            >
